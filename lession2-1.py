...
def aggregate_query(filename):
    ...
    q = """select district,gender,sum(aadhaar_generated) as aadhaar_generated
    from  aadhaar_data  where sex > 50
...
print(aggregate_query('C:\\Users\\Administrator\\PycharmProjects\\dataSciIntro\\aadhaar_data.csv'))