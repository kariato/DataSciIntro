...
def lineplot(hr_year_csv):
    pass    # A csv file will be passed in as an argument which
    ...
    gg =  ggplot(hr_year_data, aes('yearID','HR')) + geom_point(color = 'red') + geom_line(color = 'red') + ggtitle('Home Runs') + xlab('Home Runs') + ylab('Year')
    return gg
    #return gg
