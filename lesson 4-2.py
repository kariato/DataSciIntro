...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    hr_year_data=pandas.read_csv(hr_by_team_year_sf_la_csv)
    gg =  ggplot(hr_year_data, aes('yearID','HR', color='teamID')) + geom_point() + geom_line() + ggtitle('Home Runs By Teams') + xlab('Home Runs') + ylab('Year')
    return gg
